...
def selectHashTag():
    df = loadData()
    hashTags = st.multiselect("choose combination of hashtags", ['fintech'])
    if hashTags:
...
def selectLocAndAuth():
    ...
    location = st.multiselect(
        "choose Location of tweets", formatField(df, 'place_coordinate'))
    lang = st.multiselect("choose Language of tweets", formatField(df, 'language'))
